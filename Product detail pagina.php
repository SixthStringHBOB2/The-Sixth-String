...
function displayReviews($id_item) {
    ...
    foreach ($reviews as $review) {
        ...
        //echo "<p class='extrabold'>- " . ($review['id_user']) . "</p>";
        echo "</div>";
        echo "</div>";
    }
}
...
<img src="./afbeeldingen/Banner 4.jpg/" class="Banner-Img">
<div>
...
<div style="background-color: white;" class="beschrijving-flex">
    <img class="beschrijving-product-img" src="./Afbeeldingen/Gitaartje.jpg""> <!--TEST AFBEELDING!-->
    <div class="beschrijving-product" style="min-width: 30%; min-height: 60%;">
        ...
        <div class="flex-dubbel-button" style="display: flex; align-items: center; justify-content: center">
            <a href="mailto:info@TheSixthString.nl?subject=Inruilen gitaar&body=Graag ontvangen we de volgende informatie om een waardeschatting van uw product te kunnen maken:%0A %0A
1. Wat u wilt inruilen:%0A
2. Welke schade heeft het product:%0A
3. Wat is de leeftijd van het product:%0A %0A
Voeg tot slot afbeeldingen toe, zodat we een betere inschatting van de waarde kunnen maken."
            class="button3";">Gitaar inruilen
            </a>
            <a class="button4">In winkelwagen 🛒</a>
        </div>
    </div>
</div>
...
<div   class="gradient-seperation-bar">
    <div  class="flex-row-standaard" style="padding: 10px 10% 50px 10%">
        <div>
            ...
            echo renderProductInfo($queryResult);
            ?>
        </div>
...
<div class="flex-sidemenu" style="margin-bottom: 50px;">
    <div class="sidemenu">
        ...
        <?php require './Assets/submit_review.php'; ?>

            <div class="review-form">
                <form method="POST" action=""> <!-- EXTERN BESTAND REGELD HET PLAATSEN VAN DE REVIEW -->
