...
<div class="background" >
    <div class="flexcontainer-footerA">
            ...
            <div style="margin:0px 30px 0px 0px;" class="flexitem-footer">
                <h5>Mijn account</h5>
                <p><a href="./account" class="link2">Overzicht</a></p>
                <p><a href="./account" class="link2">Bestellingen</a><br></p>
                <p><a href="./account" class="link2">Retouren en reperaties</a><br></p>
                <p><a href="./account" class="link2">Gegevens en voorkeuren</a><br></p>
                <p><a href="./account" class="link2">Verlanglijstje</a></p>
            </div>
            <div class="flexitem-footer">
                <img src="../public/images/Gitaarwinkel.jpg" class='imgfooter' alt="Gitaar winkel">
            </div>
            <div class="flexitem-footer">
                <h5>Contact</h5>
